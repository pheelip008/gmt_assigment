 ...
 * replication exercise. They are replaced in Part 2, which lives in a separate
 * project.
 *
...
/* `className` carries per-word spacing: Gardena's "t" and "s" swash further
   left than the reference's script, closing the gap to the word before. */
function Script({
  children,
  className = "",
}: {
  ...
  return <span className={`script-accent ${className}`}>{children}</span>;
}
  ...
  return (
    <>
      ...
      <header className="absolute inset-x-0 top-0 z-50">
        <div className="flex items-center justify-between p-[6vw] lg:px-[4.5rem] lg:py-[1.2rem]">
      ...
      <main id="top">
        ...
        <section className="overflow-hidden bg-cream">
          ...
          <div className="flex flex-col pb-[35px] pt-[172px] lg:grid lg:grid-cols-[34.17fr_8.68fr_44.65fr_4.51fr_7.99fr] lg:pb-[62px] lg:pt-[154px]">
            <div className="relative order-2 mt-[58px] h-[304px] w-[71.3vw] lg:order-none lg:col-start-1 lg:mt-0 lg:h-[588px] lg:w-auto">
              <Image
            ...
            <div className="order-1 px-[6vw] sm:px-10 lg:order-none lg:col-start-3 lg:px-0 lg:pt-[7px]">
              <div className="max-w-[420px]">
                <Eyebrow>
                  Online &amp; in-person counseling in Newbury Park &amp; across CA
                </Eyebrow>
              </div>
              <h1 className="mt-[31px] lg:mt-[141px]">
                Rebuild your foundation on solid ground and finally begin to{" "}
                <Script className="ml-[0.07em]">thrive</Script>.
              </h1>
              <p className="mt-[30px] lg:mt-7">
                Specialized therapy for adults, couples, teens, and children to
                reflect, heal, and grow.
              </p>
              <div className="mt-[23px] lg:mt-9">
                <Btn>Book an appointment</Btn>
              </div>
            </div>

            <div className="relative order-3 -mt-[199px] ml-[85.46vw] h-[199px] w-[14.54vw] lg:order-none lg:col-start-5 lg:ml-0 lg:mt-[194px] lg:h-[393px] lg:w-auto">
              <Image
        ...
        <section className="bg-cream">
          ...
          <div className="flex flex-col px-[6vw] py-[59px] sm:px-10 lg:grid lg:grid-cols-[8.75fr_24.93fr_1.46fr_24.93fr_9.59fr_30.34fr] lg:px-0 lg:pb-[140px] lg:pt-[101px]">
            <h2 className="order-1 lg:order-none lg:col-start-2 lg:col-end-5 lg:row-start-1 lg:mt-[126px] lg:max-w-[693px]">
              You’re holding onto hope that life can be better than it is right
              now.
            </h2>

            <div className="relative order-3 mt-[46px] h-[234px] w-full self-start sm:h-[32rem] lg:order-none lg:col-start-6 lg:row-start-1 lg:row-end-3 lg:mt-0 lg:h-[626px]">
              <Image
            ...
            <div className="contents lg:col-start-2 lg:col-end-5 lg:row-start-2 lg:mt-[51px] lg:grid lg:grid-cols-2 lg:gap-x-[21px]">
              <div className="order-2 lg:order-none">
                <p className="eyebrow mt-[11px] lg:mt-0">
                  At Conejo Valley Family Counseling we want to make that hope a
                  reality.
                </p>
                <p className="mt-[15px] lg:mt-6">
        ...
        <section className="bg-white">
          <div className="px-[6vw] pb-[56px] pt-[63px] sm:px-10 lg:px-0 lg:pb-[114px] lg:pt-[95px]">
            ...
            <div className="mt-[53px] grid gap-[46px] sm:grid-cols-2 sm:gap-12 lg:mt-[50px] lg:mr-[6.11%] lg:ml-[16.32%] lg:grid-cols-3 lg:gap-5">
              {[
                {
                ...
                <div key={card.title} className="min-h-[549px] sm:min-h-0">
                  <div className="relative h-[304px] w-full sm:h-[22rem] lg:h-[416px]">
                    <Image
                      src={card.img}
                      alt={card.alt}
                      fill
                  ...
                  <h4 className="mt-[46px] lg:mt-[50px]">{card.title}</h4>
                  <p className="mt-[30px] lg:mt-4">{card.body}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <section className="relative isolate flex min-h-[66vh] items-center overflow-hidden bg-ink lg:block lg:min-h-0">
          ...
          <div className="relative w-full px-[6vw] py-10 sm:px-10 lg:px-0 lg:pb-[107px] lg:pt-[301px]">
            <h2 className="max-w-[59rem] text-cream lg:ml-[8.75%]">
        ...
        <section className="bg-white">
          <div className="px-[6vw] pb-[99px] pt-[78px] sm:px-10 lg:grid lg:grid-cols-[8.75fr_26.18fr_29.17fr_0.69fr_29.17fr_6.04fr] lg:px-0 lg:pb-[119px] lg:pt-[132px]">
            <h3 className="lg:col-start-2 lg:max-w-[316px]">
            ...
            {[
              ...
              >
                {column.map((item) => (
                  <li
                    key={item}
                    className={`label-sm border-b border-sand/50 py-[30px] max-lg:pb-[20px] max-lg:pt-[22px] max-lg:text-[15px] max-lg:leading-[27px] max-lg:tracking-[0.12em] ${i === 1 ? "max-lg:last:border-b-0 max-lg:last:pb-0" : ""}`}
                  >
                    {item}
                  </li>
                ))}
        ...
        <section className="bg-sand">
          ...
          <div className="flex flex-col px-[6vw] pb-[82px] pt-[86px] sm:px-10 lg:grid lg:grid-cols-[8.75fr_28.75fr_1.39fr_28.75fr_8.89fr_22.43fr_1.04fr] lg:px-0 lg:pb-[91px] lg:pt-[117px]">
            <div className="order-first lg:order-none lg:col-start-2 lg:col-end-5 lg:row-start-1">
              <Eyebrow>How we work</Eyebrow>
            </div>

            <h2 className="order-first mt-[30px] max-w-[57rem] lg:order-none lg:col-start-2 lg:col-end-5 lg:row-start-2 lg:mt-[88px]">
              We’re here to make a difference.
            </h2>

            <div className="order-last lg:order-none lg:col-start-2 lg:col-end-5 lg:row-start-3 lg:mt-[50px] lg:grid lg:grid-cols-[28.75fr_1.39fr_28.75fr]">
            ...
            <div className="order-last mt-[23px] lg:order-none lg:col-start-2 lg:row-start-4 lg:mt-[49px]">
              <Btn>Learn more about us</Btn>
            </div>

            <div className="relative mt-[49px] h-[269px] w-full self-start sm:h-[34rem] lg:col-start-6 lg:row-start-1 lg:row-end-5 lg:mt-0 lg:h-[714px]">
              <Image
        ...
        <section className="bg-white">
          ...
          <div className="flex min-h-[66vh] flex-col justify-center py-[56px] lg:grid lg:min-h-0 lg:grid-cols-[52.85fr_4.44fr_36.6fr_6.11fr] lg:pb-[95px] lg:pt-[95px]">
            <div className="relative ml-[6vw] h-[304px] sm:h-[28rem] lg:col-start-1 lg:ml-0 lg:h-[533px]">
              <Image
            ...
            <h2 className="px-[6vw] pt-[11px] sm:px-10 lg:col-start-3 lg:mt-[348px] lg:px-0 lg:pt-0">
        ...
        {/* ── 8. Specialties ───────────────────────────────────── */}
        <section className="bg-white">
          <div className="px-[6vw] pb-[47px] pt-[70px] sm:px-10 lg:grid lg:grid-cols-[8.75fr_25.42fr_4.44fr_55.35fr_6.04fr] lg:px-0 lg:pb-[77px] lg:pt-[78px]">
            <h3 className="lg:col-start-2 lg:max-w-[20rem]">
              Our <Script className="ml-[0.145em]">specialties</Script> include…
            </h3>
            ...
            <div className="mt-[66px] grid gap-x-[65px] gap-y-[58px] sm:grid-flow-col sm:grid-cols-2 sm:grid-rows-2 lg:col-start-4 lg:mt-[39px] lg:gap-y-[88px]">
              {[
                {
                  title: "Trauma",
                ...
                <div key={item.title} className="lg:flex lg:min-h-[339px] lg:flex-col">
                  <div className="lg:h-[272px]">
                    <h4>{item.title}</h4>
                    <p className="mt-[30px] lg:mt-4">{item.body}</p>
                  </div>
        ...
        <section className="overflow-hidden bg-cream">
          ...
          <div className="flex flex-col py-[56px] lg:grid lg:grid-cols-[11.74fr_8.19fr_36.6fr_8.26fr_34.17fr_1.04fr] lg:pb-[134px] lg:pt-[95px]">
            <div className="relative h-[199px] w-[48.6vw] lg:col-start-1 lg:mt-[117px] lg:h-[489px] lg:w-auto">
              <Image
            ...
            <div className="px-[6vw] pt-[62px] sm:px-10 lg:col-start-3 lg:px-0 lg:pt-0">
              ...
              <h2 className="mt-[27px] lg:mt-[50px]">
                Find a therapist who is the right fit for <Script>you</Script>.
              </h2>
              <p className="mt-[16px] lg:mt-[44px]">
              ...
              <p className="mt-[15px] lg:mt-6">Click the button below to schedule an appointment.</p>
            ...
            <div className="relative ml-[17.36vw] mt-[51px] h-[269px] sm:h-[32rem] lg:col-start-5 lg:ml-0 lg:mt-0 lg:h-[606px]">
              <Image
      ...
      <footer className="bg-white">
        ...
        <div className="flex flex-col px-[6vw] pb-[38px] pt-[73px] sm:px-10 lg:grid lg:grid-cols-[5fr_29.17fr_8.19fr_14.17fr_17.92fr_17.92fr_7.63fr] lg:px-0 lg:pb-[62px] lg:pt-[65px]">
          <div className="lg:col-start-2">
            <Image
              ...
              width={366}
              height={107}
              className="h-auto w-[322px] lg:w-[366px]"
            />
            <p className="mt-[11px] max-w-[28rem] px-[5.28vw] lg:mt-8 lg:px-0">
          ...
          <div className="mt-[40px] px-[11.36vw] lg:col-start-4 lg:mt-0 lg:px-0">
            ...
            <ul className="mt-[15px] text-[0.9em] lg:mt-4 lg:space-y-2 lg:text-[1em]">
          ...
          <div className="mt-[22px] px-[11.36vw] lg:col-start-6 lg:mt-0 lg:px-0">
            ...
            <address className="mt-[15px] text-[0.9em] not-italic lg:mt-4 lg:text-[1em]">
              ...
              <a href="#" className="block lg:mt-3">
            ...
            <p className="mt-[15px] max-w-[16rem] text-[0.9em] italic lg:mt-5 lg:text-[1em]">
        ...
        <div className="bg-teal">
          <div className="px-[7.77vw] pb-[11px] pt-[4px] sm:px-10 lg:px-[5%] lg:py-3">
